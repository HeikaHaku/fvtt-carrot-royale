 ...
 */
declare function fromUuid(uuid: string): Promise<Entity | any>;
 ...
 */
declare function filterObject(source: object, template: object, keepSpecial?: boolean, templateValues?: boolean): Record<string, any>;
 ...
 */
declare function flattenObject(obj: object, _d?: number): Record<string, any>;
