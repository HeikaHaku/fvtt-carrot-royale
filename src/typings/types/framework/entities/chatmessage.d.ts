...
declare class ChatMessage extends Entity {
   ...
   */
  static getSpeaker({ scene, actor, token, alias }?: { scene?: Scene; actor?: Actor; token?: Token; alias?: string }): any;

  /**
   * A helper to prepare the speaker object based on a target Token
   */
  protected static _getSpeakerFromToken({ token, alias }?: { token?: Token; alias?: string }): { scene: Scene; token: Token; actor: Actor; alias: string };
  ...
  static applyRollMode(chatData: ChatData, rollMode: string | any);
}
